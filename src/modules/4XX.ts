 ...
 */
export const BadRequest = <T>(options: HttpResponseOptions<T>) => {
 ...
 */
export const Unauthorized = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 401,
 ...
 */
export const PaymentRequired = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 402,
 ...
 */
export const Forbidden = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 403,
    message: 'Forbidden',
 ...
 */
export const NotFound = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 404,
    message: 'Not Found',
 ...
 */
export const MethodNotAllowed = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 405,
 ...
 */
export const NotAcceptable = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 406,
 ...
 */
export const RequestTimeout = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 408,
 ...
 */
export const Conflict = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 409,
    message: 'Conflict',
 ...
 */
export const Gone = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 410,
    message: 'Gone',
 ...
 */
export const LengthRequired = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 411,
 ...
 */
export const PreconditionFailed = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 412,
 ...
 */
export const PayloadTooLarge = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 413,
 ...
 */
export const URITooLong = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 414,
 ...
 */
export const Unsupported = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 415,
 ...
 */
export const RangeNotSatisfiable = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 416,
 ...
 */
export const ExpectationFailed = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 417,
 ...
 */
export const ImATeapot = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 418,
 ...
 */
export const MisdirectedRequest = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 421,
 ...
 */
export const UnprocessableEntity = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 422,
 ...
 */
export const Locked = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 423,
    message: 'Locked',
 ...
 */
export const FailedDependency = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 424,
 ...
 */
export const TooEarly = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 425,
    message: 'Too Early',
 ...
 */
export const UpgradeRequired = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 426,
 ...
 */
export const PreconditionRequired = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 428,
 ...
 */
export const TooManyRequests = <T>(options: HttpResponseOptions<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 429,
