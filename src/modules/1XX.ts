 ...
 */
export const Continue = <T>(options?: WithoutStatusAndMessage<T>) => {
 ...
 */
export const SwitchingProtocols = <T>(options?: WithoutStatusAndMessage<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 101,
 ...
 */
export const Processing = <T>(options?: WithoutStatusAndMessage<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 102,
    message: 'Processing',
 ...
 */
export const EarlyHints = <T>(options?: WithoutStatusAndMessage<T>) => {
  return createHttpResponse({
    ...options,
    statusCode: 103,
    message: 'Early Hints',
