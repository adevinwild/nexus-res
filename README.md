...
## ❓ **How to configure nexus-res**

Create a <kbd>nexus.config.json</kbd> at the root of your working directory.

```json
{
  "serverType": "express" | "koa" | "http" | "fastify" | "hapi"
  // ☝️ This will let you use the .send() function based on your server type
}
```

## ❓ **What does the interface of a response look like?**

Below the interface of HttpResponse, that is used on every classes
...
interface IHttpResponse {
   ...
   * @readonly This is generated by the core classes
   */
  message: string;
